  ...
  function mixin(namespace, globalOptions) {
    ...
    _.extend(fn, {
      ...
      buildAssociation: function(namespace, associationType, associationName, options) {
        exports.console.count('buildAssociation');
        ...
        function createAssociation() {
          exports.console.count('createAssociation');
          var self = this, 
              collectionName = _.str.classify(associationName), 
      ...
      parseAssociation: function(associationType, associationName, options) {
        exports.console.count('parseAssociation');

        function parseResponseWith(key, response) {
          exports.console.count('parseResponseWith');
          var result;
    ...
    return {
      included: function(source) {
        exports.console.count('included');
        ...
        _.extend(source, associations, {
          associations: function() {
            exports.console.count('associations');
            var self = this;
